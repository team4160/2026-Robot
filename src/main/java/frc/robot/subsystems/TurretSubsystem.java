...
// 		cancoderConfigurationA.MagnetSensor.MagnetOffset = -0.2507;
// 		cancoderA.getConfigurator().apply(cancoderConfigurationA);
// 		var cancoderConfigurationB = new CANcoderConfiguration();
// 		cancoderConfigurationB.MagnetSensor.MagnetOffset = -0.2583;
...
// 			.withGearing(new MechanismGearing(37.5))
...
// 				);
// 			}
// 			return new AbsSensorRead(false, Double.NaN, Double.NaN);
// 		}
// 		return new AbsSensorRead(false, Double.NaN, Double.NaN);
// 	}
...
// 		}
// 	}
// 	private static record AbsSensorRead(boolean ok, double absA, double absB) {}
// }
